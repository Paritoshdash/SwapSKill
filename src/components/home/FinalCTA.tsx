...
export function FinalCTA() {
    return (
        <section className="py-32 px-6 bg-transparent text-foreground drop-shadow-md overflow-hidden relative w-full h-full flex flex-col justify-center items-center">
            {/* Premium Subtle Gradient Background */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[800px] h-[400px] bg-primary/10 blur-[100px] rounded-full pointer-events-none"></div>
