...
export function ImageHeroSection() {
    ...
    return (
        <section ref={containerRef} className="relative w-full min-h-[90vh] flex flex-col items-center justify-start pt-32 pb-20 px-4 md:px-8 opacity-0">
            ...
            <div className="hero-content text-center max-w-5xl z-20 flex flex-col items-center">
                <h1 className="text-text-main font-heading font-black text-6xl md:text-[7vw] leading-[0.9] tracking-tighter capitalize drop-shadow-xl">
                ...
                <p className="mt-8 text-text-muted text-lg md:text-xl font-medium max-w-2xl px-4">
                    Trade your knowledge for new skills. No cash, just powerful peer-to-peer exchanges that accelerate your growth.
                </p>

                <Link
                    href="/signup"
                    className="mt-10 inline-flex items-center justify-center bg-primary hover:bg-secondary text-[#121212] px-8 py-4 rounded-full font-bold text-sm tracking-wide transition-all shadow-[0_0_20px_rgba(245,178,26,0.2)] hover:shadow-[0_0_30px_rgba(229,142,0,0.4)] hover:-translate-y-1 transform duration-300 pointer-events-auto"
                >
                    Start building free
                </Link>
            </div>
            ...
            <div className="relative w-full max-w-5xl h-[400px] mt-16 z-10 hidden md:block perspective-1000">
                ...
                <motion.div
                    style={{ y: yCardsSlow }}
                    className="floating-ui float-slow absolute left-1/2 top-4 -translate-x-1/2 w-[60%] h-[300px] bg-[var(--bg-card)]/80 backdrop-blur-xl border border-divider rounded-2xl shadow-2xl p-6 flex flex-col gap-4"
                >
                    {/* Fake UI Header */}
                    <div className="flex justify-between items-center border-b border-divider/50 pb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="h-4 w-24 bg-text-main/20 rounded mb-1"></div>
                    ...
                    <div className="flex gap-4 h-full">
                        <div className="w-1/3 rounded-xl bg-bg-base/50 flex flex-col gap-3 p-3">
                        ...
                        <div className="w-2/3 rounded-xl bg-divider/10 border border-divider/50 p-4">
                            <div className="h-4 w-1/2 bg-text-main/10 rounded mb-4"></div>
                ...
                <motion.div
                    ...
                    className="floating-ui float-medium absolute left-[5%] top-[80px] w-[28%] h-[180px] bg-bg-base/90 backdrop-blur border border-divider rounded-2xl shadow-xl p-4"
                >
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-8 h-8 rounded-full bg-purple-500/20"></div>
                        <div className="h-3 w-1/2 bg-text-main/20 rounded"></div>
                    </div>
                ...
                <motion.div
                    ...
                    className="floating-ui float-slow absolute right-[5%] top-[120px] w-[26%] h-[160px] bg-[#1a1c20]/90 backdrop-blur border border-divider rounded-xl shadow-xl p-4 flex flex-col justify-between"
                >
                    <div className="flex justify-end mb-2">
                        <div className="w-6 h-6 rounded-full bg-green-500/20"></div>
                    </div>
                    <div>
                        <div className="h-4 w-full bg-text-main/20 rounded mb-2"></div>
                        <div className="h-4 w-4/5 bg-text-main/20 rounded"></div>
                    </div>
                </motion.div>
