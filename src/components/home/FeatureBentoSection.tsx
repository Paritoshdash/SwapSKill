            ...
            <div className="max-w-[1400px] mx-auto p-8 md:p-16">
                ...
                <div className="max-w-3xl mb-16">
                    <h2 className="text-4xl md:text-6xl font-heading font-black text-white leading-[0.9] tracking-tighter">
                        Connect with your <span className="text-primary hover:text-secondary cursor-default transition-colors">peers</span> while we get busy in the
                        <span className="text-[#a0a0a0]"> background.</span>
                    </h2>
                </div>

                {/* Bento Grid layout inside the dark container */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">

                    {/* Bento Card 1: Smart Matching */}
                    <div className="bg-[var(--bg-card)] rounded-[32px] p-8 flex flex-col justify-between group overflow-hidden border border-white/5 hover:border-primary/30 transition-all duration-500 min-h-[400px]">
                        <div>
                            <h3 className="text-2xl font-bold text-white mb-3">Precision Matching Algorithm</h3>
                        ...
                        <motion.div
                            style={{ y: yCards }}
                            className="mt-8 bg-bg-base rounded-2xl p-4 border border-divider shadow-inner relative transform group-hover:scale-[1.02] transition-transform duration-500"
                        >
                            ...
                            <div className="space-y-3">
                                <div className="bg-divider/20 h-12 rounded-xl w-full flex items-center px-4 gap-3">
                                    <div className="w-2 h-2 rounded-full bg-green-500"></div>
                                    <div className="h-2 w-1/3 bg-text-muted/30 rounded"></div>
                                </div>
                                <div className="bg-divider/20 h-12 rounded-xl w-full flex items-center px-4 gap-3">
                                    <div className="w-2 h-2 rounded-full bg-blue-500"></div>
                                    <div className="h-2 w-1/2 bg-text-muted/30 rounded"></div>
                                </div>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="bg-[var(--bg-card)] rounded-[32px] p-8 flex flex-col justify-between group overflow-hidden border border-white/5 hover:border-secondary/30 transition-all duration-500 min-h-[400px]">
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-white mb-3">Structured Video Sessions</h3>
                            <p className="text-text-muted leading-relaxed">
                        ...
                        <motion.div
                            style={{ y: yCards }}
                            className="mt-8 bg-bg-base/50 rounded-2xl border border-divider shadow-inner h-48 relative overflow-hidden flex items-center justify-center group-hover:scale-[1.02] transition-transform duration-500"
                        >
                            {/* Fake Video Grid */}
                            <div className="absolute inset-2 grid grid-cols-2 gap-2">
                                ...
                                <div className="bg-divider/30 rounded-xl relative overflow-hidden">
                                    <div className="absolute bottom-2 left-2 text-[10px] bg-black/50 px-2 py-0.5 rounded text-white">Partner</div>
                            ...
                            {/* Fake Controls */}
                            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 bg-black/80 p-2 rounded-full backdrop-blur border border-white/10">
                    ...
                    <div className="md:col-span-2 bg-gradient-to-r from-[var(--bg-card)] to-[#1a1c20] rounded-[32px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between group border border-white/5 hover:border-primary/20 transition-all duration-500 overflow-hidden">
                        <div className="md:w-1/2 mb-8 md:mb-0 relative z-10">
                            <h3 className="text-3xl font-bold text-white mb-4">Build an irrefutable portfolio.</h3>
                        ...
                        <div className="md:w-[45%] h-56 w-full relative">
                            ...
                            <motion.div style={{ x: yGraph }} className="absolute inset-0 max-w-sm mx-auto">
                                ...
                                <svg width="100%" height="100%" viewBox="0 0 400 200" className="opacity-30 group-hover:opacity-60 transition-opacity duration-1000">
                                    <path d="M 50 100 Q 120 -20, 200 100 T 350 100" fill="transparent" stroke="var(--color-primary)" strokeWidth="3" strokeDasharray="5,5" className="animate-[dash_20s_linear_infinite]" />
                                    <path d="M 50 100 Q 150 250, 250 100 T 380 50" fill="transparent" stroke="var(--color-secondary)" strokeWidth="2" />
                                </svg>
