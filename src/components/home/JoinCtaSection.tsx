    ...
    return (
        <section className="w-full py-32 relative z-20 overflow-hidden">
            <div className="max-w-[1200px] mx-auto px-6 relative z-10 flex flex-col items-center text-center">
                ...
                <p className="text-text-muted text-lg md:text-xl font-medium max-w-xl mb-12 leading-relaxed">
                    Stop paying for bootcamps. Start trading your knowledge in the world&apos;s first peer-to-peer skill economy.
                </p>

                <Link href="/signup" className="group relative inline-flex items-center justify-center px-10 py-5 font-bold text-black bg-primary rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(245,178,26,0.3)] hover:shadow-[0_0_60px_rgba(229,142,0,0.5)]">
            ...
            <div className="absolute bottom-0 left-0 w-full h-[150px] bg-gradient-to-t from-black to-transparent pointer-events-none z-10"></div>
        </section>
    );
}
