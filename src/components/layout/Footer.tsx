...
export function Footer() {
    return (
        <footer className="border-t border-white/10 bg-[#050505] pt-20 pb-10 px-6 font-inter">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                <div className="space-y-4 md:col-span-1">
                    ...
                    <p className="text-gray-500 text-sm">Empowering global learners through decentralized, demonetized knowledge exchange.</p>
                </div>

                <div className="space-y-4">
                    <h4 className="font-semibold text-white">Platform</h4>
                    <ul className="space-y-2 text-sm text-gray-500">
                        <li><Link href="/skills" className="hover:text-white transition-colors">Browse Skills</Link></li>
                        <li><Link href="/offer-skill" className="hover:text-white transition-colors">Offer a Skill</Link></li>
